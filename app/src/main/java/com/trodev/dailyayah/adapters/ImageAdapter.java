package com.trodev.dailyayah.adapters;
...
import com.trodev.dailyayah.activities.FullDataActivity;
import com.trodev.dailyayah.R;
import com.trodev.dailyayah.models.UploadData;
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context, "আয়াতঃ " + uploadData.getmName(), Toast.LENGTH_SHORT).show();
